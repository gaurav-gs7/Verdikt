...
def run_demo(runtime: VerdiktRuntime) -> None:
    print("Verdikt interview demo")
    print("========================")
...
def _call(runtime: VerdiktRuntime, label: str, server: str, tool: str, arguments: dict[str, Any]) -> None:
    print(f"\n{label}")
