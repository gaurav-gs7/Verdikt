...
_AUTHENTICATED_SUBJECT: ContextVar[str] = ContextVar("mcp_guard_authenticated_subject", default="")
_AUTHENTICATED_CLAIMS: ContextVar[dict[str, Any]] = ContextVar(
    "mcp_guard_authenticated_claims", default={}
)
...
def is_control_plane_admin() -> bool:
    ...
    required_scope = os.getenv("MCP_GUARD_ADMIN_SCOPE", "mcp:admin")
    ...
    return os.getenv("MCP_GUARD_ADMIN_GROUP", "mcp-admin") in groups
