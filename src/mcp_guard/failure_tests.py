...
def _kill_switch_case(runtime: GuardedOpsRuntime) -> tuple[bool, str]:
...
def _circuit_breaker_case(runtime: GuardedOpsRuntime) -> tuple[bool, str]:
...
def _redaction_case(runtime: GuardedOpsRuntime) -> tuple[bool, str]:
...
def _rate_limit_case(runtime: GuardedOpsRuntime) -> tuple[bool, str]:
    last = None
    for _ in range(11):
