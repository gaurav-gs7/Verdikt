...
class AuditStore:
    def __init__(self, path: Path) -> None:
        ...
        self._signing_secret = os.getenv("MCP_GUARD_AUDIT_HMAC_SECRET", "")
        self._instance_id = os.getenv("MCP_GUARD_INSTANCE_ID", "local")
        self._sink_strict = os.getenv("MCP_GUARD_AUDIT_SINK_STRICT", "").lower() in {"1", "true", "yes"}
